    ...
    <div class="main-body">
        <div class="row gutters-sm">
            <div class="col-md-4 mb-3">
               <div class="card">
                  <div class="card-body">
                     <div class="d-flex flex-column align-items-center text-center" style="cursor: pointer;">
                        <img src="{{ asset($user->user_pic) }}" alt="Admin" class="rounded-circle" id="profileImage" width="150" height="150">
                        {{-- <input id="imageUpload" type="file" name="profile_photo" placeholder="Photo" required="" capture> --}}
                        <input id="imageUpload" type="file" name="user_pic" placeholder="Photo" required="" capture>
                        <div class="mt-3">
                           <h4>{{ Auth::guard('admin')->user()->name }}</h4>
                           {{-- <p class="text-secondary mb-1">{{ Auth::guard('admin')->user()->name }}</p> --}}
                           <p class="text-muted font-size-sm">{{ $setting[0]->contact }}</p>
               ...
               <div class="card mt-3">
                  <ul class="list-group list-group-flush">
                     <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span class="text-secondary">http://anthonysboutique.com/</span>
                     </li>
                     <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 class="mb-0">
                     ...
                     <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span class="text-secondary">{{ $setting[0]->instragram_link }}</span>
                     </li>
                     <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        <h6 class="mb-0">
                        ...
                        <span class="text-secondary">{{ $setting[0]->facebook_link }}</span>
                     </li>
                  </ul>
               </div>
            </div>
